...
//	
//	/**
//	 * Construct the obstacles option
//	 */
//	
//	private static Option constructObstaclesOption() {
//		String optionInfo = "Number of obstacles. (defualt 5)";
...
//			}
//			if (obstacles != null) {
//				ataxxFactory.setObstacles(obstacles);
//			}
...
//			formatter.printHelp(MainA.class.getCanonicalName(), cmdLineOptions, true);
//			System.exit(0);
//		}
//	}
//
//	/**
//	 * Parser for obstacles option
//	 */
//	
...
//			} catch (NumberFormatException e) {
//				throw new ParseException("Invalid obstacles: " + obs);
//			}
//		}
//	}
//	
